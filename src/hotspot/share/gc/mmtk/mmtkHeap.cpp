...
//
//PSYoungGen*  MMTkHeap::_young_gen = NULL;
//PSOldGen*    MMTkHeap::_old_gen = NULL;
//PSAdaptiveSizePolicy* MMTkHeap::_size_policy = NULL;
//PSGCAdaptivePolicyCounters* MMTkHeap::_gc_policy_counters = NULL;
//GCTaskManager* MMTkHeap::_gc_task_manager = NULL;
//
...
//}
//
//void MMTkHeap::initialize_serviceability() {
//
...
//HeapWord* MMTkHeap::mem_allocate(
//                                     size_t size,
...
//          log_trace(gc)("MMTkHeap::mem_allocate: return NULL because gc_overhead_limit_exceeded is set");
//          if (op.result() != NULL) {
...
//      log_warning(gc)("MMTkHeap::mem_allocate retries %d times", loop_count);
...
//void
//MMTkHeap::death_march_check(HeapWord* const addr, size_t size) {
//  if (addr != NULL) {
...
//}
//
//HeapWord* MMTkHeap::mem_allocate_old_gen(size_t size) {
...
//}
//
//void MMTkHeap::do_full_collection(bool clear_all_soft_refs) {
//  if (UseParallelOldGC) {
...
//HeapWord* MMTkHeap::failed_mem_allocate(size_t size) {
...
//}
//
//void MMTkHeap::ensure_parsability(bool retire_tlabs) {
...
//}
//
//size_t MMTkHeap::unsafe_max_tlab_alloc(Thread* thr) const {
//  return young_gen()->eden_space()->unsafe_max_tlab_alloc(thr);
//}
//
//HeapWord* MMTkHeap::allocate_new_tlab(size_t size) {
//  return young_gen()->allocate(size);
//}
//
//void MMTkHeap::accumulate_statistics_all_tlabs() {
//  CollectedHeap::accumulate_statistics_all_tlabs();
//}
//
//void MMTkHeap::resize_all_tlabs() {
...
//void MMTkHeap::collect(GCCause::Cause cause) {
...
//}
//
//void MMTkHeap::object_iterate(ObjectClosure* cl) {
//  young_gen()->object_iterate(cl);
//  old_gen()->object_iterate(cl);
//}
//
//
//HeapWord* MMTkHeap::block_start(const void* addr) const {
...
//}
//
//size_t MMTkHeap::block_size(const HeapWord* addr) const {
//  return oop(addr)->size();
//}
//
//bool MMTkHeap::block_is_obj(const HeapWord* addr) const {
//  return block_start(addr) == addr;
//}
//
//jlong MMTkHeap::millis_since_last_gc() {
...
//}
//
//PSHeapSummary MMTkHeap::create_ps_heap_summary() {
...
//}
//
//void MMTkHeap::print_on_error(outputStream* st) const {
...
//
//
//void MMTkHeap::verify(VerifyOption option /* ignored */) {
...
//}
//
//void MMTkHeap::trace_heap(GCWhen::Type when, const GCTracer* gc_tracer) {
...
//}
//
//MMTkHeap* MMTkHeap::heap() {
//  CollectedHeap* heap = Universe::heap();
//  assert(heap != NULL, "Uninitialized access to MMTkHeap::heap()");
//  assert(heap->kind() == CollectedHeap::MMTkHeap, "Not a MMTkHeap");
...
//void MMTkHeap::resize_young_gen(size_t eden_size,
...
//// the reserved space for the young and old generations
//// may be changed to accommodate the desired resize.
//void MMTkHeap::resize_old_gen(size_t desired_free_space) {
//  if (UseAdaptiveGCBoundary) {
//    if (size_policy()->bytes_absorbed_from_eden() != 0) {
//      size_policy()->reset_bytes_absorbed_from_eden();
//      return;  // The generation changed size already.
...
//}
//
//MMTkHeap::ParStrongRootsScope::ParStrongRootsScope() {
//  // nothing particular
//}
//
//MMTkHeap::ParStrongRootsScope::~ParStrongRootsScope() {
...
//
//#ifndef PRODUCT
//void MMTkHeap::record_gen_tops_before_GC() {
...
//}
//
//void MMTkHeap::gen_mangle_unused_area() {
//  if (ZapUnusedHeapArea) {
...
//#endif
//
//bool MMTkHeap::is_scavengable(oop obj) {
