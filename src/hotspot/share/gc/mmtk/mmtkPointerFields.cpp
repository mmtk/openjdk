...
void MMTkPointerFields::initialize() {
...
void MMTkPointerFields::allocate_stacks() {
  ParallelScavengeHeap* heap = ParallelScavengeHeap::heap();
  PSYoungGen* young_gen = heap->young_gen();
...
void MMTkPointerFields::deallocate_stacks() {
...
Stack<oop, mtGC> MMTkPointerFields::collectPointerFields(oop obj) {
      obj->oop_iterate(&mark_and_push_closure);
      //return this->_marking_stack;  //need to test
