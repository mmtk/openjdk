...
#include "gc/mmtk/mmtkMarkSweep.hpp"
...
void MMTkMarkSweep::allocate_stacks() {
  ParallelScavengeHeap* heap = ParallelScavengeHeap::heap();
  PSYoungGen* young_gen = heap->young_gen();
...
void MMTkMarkSweep::deallocate_stacks() {
...
void MMTkMarkSweep::collectRoots() {
